    ...
    <div class="text-center" id="form">
        <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" id="btn_report">Production Report&nbsp&nbsp<span class="caret"></span></button>
                    <ul class="dropdown-menu">
...
<?php
				if(!empty($_POST['report']) && $_POST['report'] == 2)
				{ 
