...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="to" name="to" value="Slitting"  disabled>
            </div>
           ...
           <div class="form-group">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu" id="dropdown_material">
                        ...
                        <?php
    $multilayer->consumablesDropdown();
?>
                    </ul>
                </div>
            </div>
            <div class="form-group">
                ...
                <input type="number" class="form-control"  min="1" id="bags" name="bags" required>
            </div>
               </div>
