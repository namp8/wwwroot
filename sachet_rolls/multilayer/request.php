...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="to" name="to" value="Multilayer"  disabled>
            </div>
	...
	function modal(id)
		{
			if(id == 2)
			{
            	...
            	document.getElementById("machine").value = 2;
			}
			else
			{
				document.getElementById("materialbtn").removeAttribute("class");
            	...
            	document.getElementById("machine").value = 11;
			}
		}
