        ...
        <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a onclick="selectReport(1)">Efficiency Report</a></li>
                        <li><a onclick="selectReport(2)">Production Report</a></li>
...
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            if(id ==1)
            {
                name = "Multilayer - Efficiency Report";
            }
            else if (id == 2)
            {
                name = "Multilayer - Production Report";
            }
            else if (id == 3)
            {
                name = "Multilayer - Waste Report";
            }
            else if (id == 4)
            {
                name = "Multilayer - Raw Material Consumption Report";
            }
			else if (id == 5)
            {
                name = "Multilayer - Short Fall and Downtime Report";
            }
            else if (id == 6)
            {
            ...
            {
                name = "Multilayer - Stock Details by Material";
            }
...
<?php
				...
				{ 
					...
					$(api.column(1).footer()).html(
						''+ pageTotal1.toLocaleString(undefined, {
  ...
  maximumFractionDigits: 1
					...
					// TOTAL 4
					pageTotal4 = pageTotal3/pageTotal2*100;
  ...
  maximumFractionDigits: 1
					...
					pageTotal6 = theColumnTotal / columnData.count();
  ...
  maximumFractionDigits: 1
					...
					// Total Bags
					pageTotal7 = pageTotal5/pageTotal3*100;
