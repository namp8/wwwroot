<?php
    $pageTitle = "Multilayer Stock (Raw)";
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST" and !empty($_POST['material']))
    {
        ...
        if($stock->balanceStockMaterials(2)){
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Balance Multilayer Stock</h4>
          </div>
...
<script>
  ...
  maximumFractionDigits: 2
	     ...
	     function exportToPDF() {
                ...
                var dd = {
                    content: [{
                            text: 'List of materials on Multilayer section',
                            style: 'header'
                        },
                        {
                    ...
                    pdfMake.createPdf(dd).download("List of materials on Multilayer section "+new Date().toLocaleString() +'.pdf');
                }  
        </script>
