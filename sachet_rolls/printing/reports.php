...
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            {
                name = "Short Fall and Downtime Report";
            }
    ...
    <script>
     function exportToPDF() {
                ...
                var dd = {
                    ...
                    pdfMake.createPdf(dd).download(document.getElementById("titleReport").innerHTML + '.pdf');
                }    
    </script>
