<?php
    $pageTitle = "Sacks - Packing - Reports";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Packing - Reports</li>
    </ol>
    <h2>Sacks - Packing - Reports</h2>
        ...
        <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a onclick="selectReport(1)">Packing - Efficiency Report</a></li>
                        <li><a onclick="selectReport(2)">Packing - Production Report</a></li>
...
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            if(id ==1)
            {
                name = "Packing - Efficiency Report";
            }
            else if (id == 2)
            {
            ...
            {
                name = "Packing - Waste Report";
            }
            else if (id == 4)
            {
                name = "Packing - Raw Material Consumption Report";
            }
			else if (id == 5)
            {
                name = "Packing - Short Fall and Downtime Report";
            }
            else if (id == 6)
            {
                name = "Packing - Cutting Sacks on Floor Details";
            }
