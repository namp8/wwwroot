...
?>
    ...
    <h2>Sacks - Packing - Short Fall</h2>
...
<div class="pull-right text-right">
		<div class="dropdown" style="margin-top:5px;margin-right:30px;">
			<button class="btn btn-info" type="button" onclick="selectMachine(31,'Packing')" data-toggle="modal" data-target="#modal1">Submit Reason for Short Fall</button>
		</div>
	</div>
