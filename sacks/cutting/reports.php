<?php
    $pageTitle = "Sacks - Cutting - Reports";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Cutting - Reports</li>
    </ol>
    <h2>Sacks - Cutting - Reports</h2>
        ...
        <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a onclick="selectReport(1)">Cutting - Efficiency Report</a></li>
                        <li><a onclick="selectReport(2)">Cutting - Production Report</a></li>
                        <li><a onclick="selectReport(3)">Cutting - Waste Report</a></li>
...
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            if(id ==1)
            {
                name = "Cutting - Efficiency Report";
            }
            else if (id == 2)
            {
                name = "Cutting - Production Report";
            }
            else if (id == 3)
            {
                name = "Cutting - Waste Report";
            }
            else if (id == 4)
            {
                name = "Cutting - Raw Material Consumption Report";
            }
			else if (id == 5)
            {
                name = "Cutting - Short Fall and Downtime Report";
            }
            else if (id == 6)
            {
                name = "Cutting - Rolls on Floor Details";
            }
            else if (id == 7)
            {
                name = "Cutting - Cutting Sacks on Floor Details";
            }
