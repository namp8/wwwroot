<?php
    $pageTitle = "Sacks Extruder Request";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Extruder - Request</li>
    </ol>
    <h2>Sacks - Extruder - Request</h2>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="dataTable2" width="100%" cellspacing="0">
                        ...
                        <tbody>
<?php  
    $stock->stockConsumablesRequest(7);
?>
                        </tbody>
                    </table>
                </div>
