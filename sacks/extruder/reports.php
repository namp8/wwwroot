<?php
    $pageTitle = "Sacks - Extruder - Reports";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Extruder - Reports</li>
    </ol>
    <h2>Sacks - Extruder - Reports</h2>
        ...
        <form class="form-inline" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a onclick="selectReport(1)">Extruder - Efficiency Report</a></li>
                        <li><a onclick="selectReport(2)">Extruder - Production Report</a></li>
                        <li><a onclick="selectReport(3)">Extruder - Waste Report</a></li>
                        <li><a onclick="selectReport(4)">Extruder - Raw Material Consumption Report</a></li>
                        <li><a onclick="selectReport(5)">Extruder - Short Fall and Downtime Report</a></li>
                        <li><a onclick="selectReport(6)">Extruder - Raw Material Stock Details</a></li>
                        <li><a onclick="selectReport(7)">Extruder - Rolls on Floor Details</a></li>
                    </ul>
                </div>
            </div>
            <div class="form-group">
 ...
 <?php
    if( empty($_POST['report']) or $_POST['report'] == 1 )
    {
		...
		$sacks->reportEfficiency();        
		echo '</table>';
    }     
    else if( empty($_POST['report']) or $_POST['report'] == 2 )
    {
        echo '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0"  >';
        $sacks->reportProduction();
		echo '</table>';
    }  
    ...
    {
        $sacks->reportMaterialConsumption();
    }
    ...
    {
        echo '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0"  >';
        $sacks->reportRawMaterial();
		echo '</table>';
    }
	else if( empty($_POST['report']) or $_POST['report'] == 7 )
    {
        echo '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0"  >';
        $sacks->reportRollsExtruder();
		echo '</table>';
    }
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            if(id ==1)
            {
                name = "Extruder - Efficiency Report";
            }
            else if (id == 2)
            {
                name = "Extruder - Production Report";
            }
            else if (id == 3)
            {
                name = "Extruder - Waste Report";
            }
            else if (id == 4)
            {
                name = "Extruder - Raw Material Consumption Report";
            }
			else if (id == 5)
            {
                name = "Extruder - Short Fall and Downtime Report";
            }
            else if (id == 6)
            {
                name = "Extruder - Raw Material Stock Details";
            }
            else if (id == 7)
            {
                name = "Extruder - Rolls on Floor Details";
            }
