<?php
    $pageTitle = "Sacks - Extruder Receive";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Extruder - Receive</li>
    </ol>
    <h2>Sacks - Extruder - Receive</h2>
