...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="process.php">Warehouse</a>
        </li>
...
?>
    ...
    <button class="btn btn-info pull-right" style="margin-top:5px;margin-right:30px;" data-toggle="modal" data-target="#modal2" onclick="modal(1)">Use Consumable Item in Warehouse</button> 
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
<?php  
    $stock->stockReceiptsWarehouse(1);
?>
                        </tbody>
                    </table>
                </div>
