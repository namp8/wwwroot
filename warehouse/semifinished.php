<?php
    $pageTitle = "Warehouse - Semi finished Goods";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Semi finished Goods</li>
    </ol>
    <h2>Warehouse - Semi finished Goods</h2>
                ...
                <div class="form-group">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->semifinishedStockDropdown(1);
?>
						</ul>
					</div>
                </div>
