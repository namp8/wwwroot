<?php
    $pageTitle = "Warehouse - MasterBatch";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">MasterBatch</li>
    </ol>
    <h2>Warehouse - MasterBatch</h2>
...
?>
    <div class="panel panel-info">
        <div class="panel-heading"> List of MasterBatch </div>
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="material">MasterBatch  <span class="text-danger">*</span></label>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->masterbatchStockDropdown(1);
?>
						</ul>
					</div>
                </div>
  ...
  maximumFractionDigits: 2
	     ...
	     function exportToPDF() {
                ...
                var dd = {
                    content: [{
                            text: 'List of MasterBatch in Warehouse stock',
                            style: 'header'
                        },
                        {
                    ...
                    pdfMake.createPdf(dd).download("List of MasterBatch in Warehouse stock "+new Date().toLocaleString() +'.pdf');
                }  
        </script>
    <?php
