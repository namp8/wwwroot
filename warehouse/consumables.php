<?php
    $pageTitle = "Warehouse - Consumables";
...
?>
    <div class="panel panel-info">
        <div class="panel-heading"> List of consumables in Warehouse stock </div>
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="material">Consumable <span class="text-danger">*</span></label>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->consumablesStockDropdown(1);
?>
						</ul>
					</div>
                </div>
