<?php
    $pageTitle = "Warehouse - Spare Parts";
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="material">Spare Part<span class="text-danger">*</span></label>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->sparepartsStockDropdown(1);
?>
						</ul>
					</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" min="0.001" step="0.001" id="newbags" name="newbags" onkeyup="calculate()" required>
                </div>
			  	<div class="form-group">
  ...
  maximumFractionDigits: 2
	     ...
	     function exportToPDF() {
                ...
                var dd = {
                    content: [{
                            text: 'List of Spare Parts in stock',
                            style: 'header'
                        },
                        {
                    ...
                    pdfMake.createPdf(dd).download("List of Spare Parts in stock "+new Date().toLocaleString() +'.pdf');
                }  
        </script>
    <?php
