...
<div id="sidebar" class="sidebar-toggle">
	<ul class="nav nav-sidebar">
		...
		<li role="separator" class="divider"></li>
		<li role="separator" class="divider"></li>
		<li><a href="/warehouse/home.php"><i class="fa fa-building" aria-hidden="true"></i><span>Warehouse</span></a></li>
		<li role="separator" class="divider"></li>
		<li><a href="/finishedgoods/home.php"><i class="fa fa-cubes" aria-hidden="true"></i><span>Finished Goods</span></a></li>
		<li role="separator" class="divider"></li>
		<li role="separator" class="divider"></li>
		<li role="separator" class="divider"></li>
		<li><a href="/sacks/process.php"><i class="fa fa-clone" aria-hidden="true"></i><span>Sacks</span></a></li>
		<li role="separator" class="divider"></li>
		<li><a href="/injection/process.php"><i class="fa fa-hdd-o" aria-hidden="true"></i><span>Injection</span></a></li>
		<li role="separator" class="divider"></li>
		<li><a href="/sachet_rolls/process.php"><i class="fa fa-battery-empty" aria-hidden="true"></i><span>Sachet Rolls</span></a></li>
		<li role="separator" class="divider"></li>
		<li><a href="/packing_bag/process.php"><i class="fa fa-square-o" aria-hidden="true"></i><span>Packing Bags</span></a></li>
		<li role="separator" class="divider"></li>
		<li><a href="/macchi/process.php"><i class="fa fa-battery-full" aria-hidden="true"></i><span>Macchi</span></a></li>
