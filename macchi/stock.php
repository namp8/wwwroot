...
?>
    ...
    <h2>Macchi - Raw Material on floor</h2>
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST" and !empty($_POST['material']))
    {
        ...
        if($stock->balanceStockMaterials(5)){
...
?>
    <div class="panel panel-info">
        <div class="panel-heading"> List of materials on Macchi section </div>
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Balance Macchi Section Stock</h4>
          </div>
                ...
                <div class="form-group">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->materialsStockDropdown(5);
?>
						</ul>
					</div>
                </div>
...
<script>
  ...
  maximumFractionDigits: 2
	     ...
	     function exportToPDF() {
                ...
                var dd = {
                    content: [{
                            text: 'List of materials on Macchi section',
                            style: 'header'
                        },
                        {
                    ...
                    pdfMake.createPdf(dd).download("List of materials on Macchi section "+new Date().toLocaleString() +'.pdf');
                }  
        </script>
