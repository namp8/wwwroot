<?php
    $pageTitle = "Packing Bags Reports";
...
?>
         ...
         <button class="btn btn-info pull-right" style="margin-top:5px;margin-right:30px;" onclick="exportToPDF()">Export Table to PDF</button>
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="col-md-12" id="divChart1">
 ...
 <?php
    if( empty($_POST['report']) or $_POST['report'] == 1 )
    {
		...
		$packing->reportEfficiency();        
		echo '</table>';
    }     
    else if( empty($_POST['report']) or $_POST['report'] == 2 )
    {
        echo '<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0"  >';
        $packing->reportProduction();
		echo '</table>';
    }  
...
?>
    ...
    <script>
        ...
        function selectReport(id) {
            ...
            if(id ==1)
            {
                name = "Packing Bags - Efficiency Report";
            }
            else if (id == 2)
            {
                name = "Packing Bags - Production Report";
            }
            else if (id == 3)
            {
                name = "Packing Bags - Waste Report";
            }
            else if (id == 4)
            {
                name = "Packing Bags - Raw Material Consumption Report";
            }
			else if (id == 5)
            {
                name = "Packing Bags - Short Fall and Downtime Report";
            }
            else if (id == 6)
            {
                name = "Packing Bags - Stock Details";
            }
			else if (id == 7)
            {
                name = "Packing Bags - Stock Details by Material";
            }
