...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Raw Material on floor</li>
    </ol>
    <h2>Multilayer & Packing Bags - Raw Material on floor</h2>
...
<?php
    if($_SERVER["REQUEST_METHOD"] == "POST" and !empty($_POST['material']))
    {
        ...
        if($stock->balanceStockMaterials(8)){
...
?>
    <div class="panel panel-info">
        <div class="panel-heading"> List of materials on Multilayer & Packing Bags section </div>
      ...
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Balance Packing Bag Section Stock</h4>
          </div>
                ...
                <div class="form-group">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu" id="dropdown_material">
							...
							<?php
$materials->materialsStockDropdown(11);
?>
						</ul>
					</div>
                </div>
                <div class="form-group">
                    <label for="oldbags">Bags on UPS<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" min="1" id="oldbags" name="oldbags" readonly="readonly">
                </div>
                <div class="form-group">
                    <label for="newbags">Bags on floor<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" min="1" id="newbags" name="newbags" onkeyup="calculate()" required>
                </div>
			  	<div class="form-group">
...
<script>
  ...
  maximumFractionDigits: 2
	     ...
	     function exportToPDF() {
                ...
                var dd = {
                    content: [{
                            text: 'List of materials on Packing Bag section',
                            style: 'header'
                        },
                        {
                    ...
                    pdfMake.createPdf(dd).download("List of materials on Packing Bag section "+new Date().toLocaleString() +'.pdf');
                }  
        </script>
