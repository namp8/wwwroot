<?php
    $pageTitle = "Packing Bags - Cutting -  Request";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="process.php">Packing Bags - Cutting</a>
        </li>
        <li class="breadcrumb-item active">Request</li>
    </ol>
    <h2>Packing Bags - Cutting - Request</h2>
...
?>
    ...
    <button class="btn btn-info pull-right" style="margin-top:5px;margin-right:30px;" data-toggle="modal" data-target="#modal1">Request consumable items</button>
...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="to" name="to" value="Packing Bags"  disabled>
            </div>
            
           <div class="form-group">
                <label for="material">Consumable Item <span class="text-danger">*</span></label>
...
?>
            ...
            <div class="form-group">
                <label for="total">Total qty <span class="text-danger">*</span></label>
...
<script>        
         function selectConsumable(id, name) {
            document.getElementById("btn_material").innerHTML = name + " &nbsp&nbsp<span class='caret'></span> ";
