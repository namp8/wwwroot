		...
		<li role="separator" class="divider"></li>
					...
					<li>
						<ul id="submenu" class="sub-menu collapse">
							<li ><a  href="extruder/process.php"><i class="fa fa-recycle" aria-hidden="true" ></i><span>&nbsp Process</span></a></li>
							...
							<li><a href="extruder/formula.php"><i class="fa fa-eyedropper" aria-hidden="true"></i><span>&nbsp Formula</span></a></li>
                            ...
                            <li><a class="four" href="extruder/rolls_stock.php"><i class="fa fa-exchange" aria-hidden="true"></i><span>&nbsp Rolls Tracker </span></a></li>
					...
					<li data-toggle="collapse" href="#cutting" aria-expanded="true" aria-controls="cutting">
						<a href="#"> 
							<i class="fa fa fa-clone fa-fw" aria-hidden="true"></i><span>CUTTING</span>
						</a>
					</li>
