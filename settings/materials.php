...
?>
	...
	<div class="pull-right text-right">
			<button class="btn btn-info btn-add" type="button" data-toggle="modal" data-target="#modal1" onclick="add()">Create Material</button>
	</div>
...
<div class="modal fade" id="modal1" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="panelTitle">Create Material</h4>
          </div>
    ...
    <script>
		function add() {
            ...
            document.getElementById("panelTitle").innerHTML = "Create material";
        ...
        function edit(id,name,grade,kgs,sacks,cutting,multilayer,printing,injection,macchi,packing) {
            ...
            document.getElementById("buttonForm").setAttribute("class","btn btn-info");  
            document.getElementById("panelTitle").innerHTML = "Edit material";
            document.getElementById("panel_add").style.display = "";
