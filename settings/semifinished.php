<?php
    $pageTitle = "Settings - Semifinished Products";
...
?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Semifinished Products</li>
    </ol>
    <h2>Settings - Semifinished Products</h2>
...
?>
	...
	<div class="pull-right text-right">
			<button class="btn btn-info btn-add" type="button" data-toggle="modal" data-target="#modal1" onclick="add()">Create Semifinished Product</button>
	</div>
    <div class="panel panel-info">
        <div class="panel-heading">List of Semifinished Products</div>
...
<div class="modal fade" id="modal1" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="panelTitle">Create Semifinished Product</h4>
          </div>
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
			  	...
			  	<div id="panel_add">
			  	<div class="form-group">
                    <label for="form">Kgs per unit</label>
    ...
    <script>
		function add() {
            ...
            document.getElementById("panelTitle").innerHTML = "Create Semifinished Product";
        ...
        function edit(id,name,grade,kgs,sacks,cutting,multilayer,printing,injection,macchi,packing) {
            ...
            document.getElementById("buttonForm").setAttribute("class","btn btn-info");  
            document.getElementById("panelTitle").innerHTML = "Edit Semifinished Product";
            document.getElementById("panel_add").style.display = "";
        ...
        function deleteMaterial(id,name,grade) {
            ...
            document.getElementById("panelTitle").innerHTML = "Delete Semifinished Product";
