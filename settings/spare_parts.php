<?php
    $pageTitle = "Settings - Spare Parts";
...
?>
	...
	<div class="pull-right text-right">
			<button class="btn btn-info btn-add" type="button" data-toggle="modal" data-target="#modal1" onclick="add()">Create Spare Part</button>
	</div>
    <div class="panel panel-info">
        <div class="panel-heading">List of Spare Parts</div>
...
<div class="modal fade" id="modal1" role="dialog" tabindex="-1">
      <div class="modal-dialog modal-m">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="panelTitle">Create Spare Part</h4>
          </div>
          ...
          <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="form">Spare Part Name</label>
                    <input type="text" class="form-control" id="name" name="name">
                </div>
			  	<div class="form-group">
                    <label for="form">Specifications</label>
    ...
    <script>
		function add() {
            ...
            document.getElementById("panelTitle").innerHTML = "Create Spare Part";
        ...
        function edit(id,name,grade,kgs,sacks,cutting,multilayer,printing,injection,macchi,packing) {
            ...
            document.getElementById("buttonForm").setAttribute("class","btn btn-info");  
            document.getElementById("panelTitle").innerHTML = "Edit Spare Part";
            document.getElementById("panel_add").style.display = "";
        ...
        function deleteMaterial(id,name,grade) {
            ...
            document.getElementById("panelTitle").innerHTML = "Delete Spare Part";
